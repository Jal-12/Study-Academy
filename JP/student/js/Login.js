const enoFiled = document.querySelector("#eno")
const passFiled = document.querySelector("#pass")
...
enoFiled.addEventListener("focus", happy)
passFiled.addEventListener("focus", hide)
