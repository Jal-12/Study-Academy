	...
	if ($records==0){
		...
		?>
							<tr>
								...
								<td >
									<a href="edit_questions.php?exam_id=<?php echo $row['exam_id']; ?>&group_id=<?php echo $group_id ?>" class="btn  btn-primary">Edit</a>
								</td>
								<td >
									<a href="delete.php?exam_id=<?php echo $row['exam_id']; ?>&group_id=<?php echo $group_id ?>" class="btn  btn-danger" href="">Delete</a>
								</td>
							</tr>
					<?php
							}
