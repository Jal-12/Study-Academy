    ...
    // this condition checks get variable of sem_id  if admin click on semester 1 then sem_id available and records will view as semester wise
        ...
        <div class="card">
            <div class="card-header">
                <h3 class="text-center font-weight-bold"><?php echo $semEcho.d_id($d_id); ?>- Exam Result</h3>
            </div>
            <center>
                    ...
                    if (isset($subSql)) {
                        ...
                        while ($subRow = mysqli_fetch_assoc($subResult)) {
                            ...
                            if ($subRow['sub_id'] == $sub_id1) {
                                echo '<a class="btn btn-warning  m-2 my-4" href="view_results.php?d_id=' . $d_id . '&sem_id=' . $sem_id . '&sub_id=' . $subRow['sub_id'] . '">' . sub_id($subRow['sub_id']) . '</a>';
                            } else {
                                echo '<a class="btn btn-primary  m-2 my-4" href="view_results.php?d_id=' . $d_id . '&sem_id=' . $sem_id . '&sub_id=' . $subRow['sub_id'] . '">' . sub_id($subRow['sub_id']) . '</a>';
                            }    
                        }
                    }
                    ?>
            ...
            <tr>
                ...
                if ($now<$start_time) 
                {
                    echo '<td style="text-align: center">
                            <p class="btn btn-sm btn-dark " name="">Exam not Started</p>
                          </td>';
                    ...
                    echo '<td style="text-align: center">
                            <a href="given_exam.php?group_id='.$group_id.'" class="btn btn-primary">View Result</a>
                          </td>';
                }
                ?>
                </tr>
