  ...
  <body>
   <form action="Forgot.php" method="post">
	<div class="box">
     ...
     <input type="email" id="email" name="email" autocomplete="off" placeholder="Enter Email" required>
    </br>      
     <label for="pass">New Password: </label>
     <input type="password" id="pass" name="password" autocomplete="off" placeholder="New Password" required>
...
// value update query for password
    $q="UPDATE admin SET password ='$_POST[password]',`update_time`=current_timestamp() WHERE email = '$_POST[email]' ";
