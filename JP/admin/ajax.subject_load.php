...
?>
	<tr>
		<td colspan="4" align="center" class="font-weight-bold text-primary"><?php echo '<button class="btn-warning">'.sub_id($sub_id).'</button>'; ?>
		</td>
	</tr>
	<?php
	...
	if (mysqli_num_rows($result)>0) {
		...
		while ($row=mysqli_fetch_array($result)) {
			...
			echo'<tr>
					...
					<td  width="9%">
						<button class="btn-warning unit"  data-unit="'.$row["sub_id"].'" >Units</button>
					</td>
					<td  width="9%">
