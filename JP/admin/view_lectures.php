				...
				if (isset($subSql)) {
					...
					while ($subRow = mysqli_fetch_assoc($subResult)) {
						...
						if ($subRow['sub_id'] == $sub_id1) {
							echo '<a class="btn btn-warning  m-2 my-4" href="view_lectures.php?d_id=' . $d_id . '&sem_id=' . $sem_id . '&sub_id=' . $subRow['sub_id'] . '">' . sub_id($subRow['sub_id']) . '</a>';
						} else {
							echo '<a class="btn btn-primary  m-2 my-4" href="view_lectures.php?d_id=' . $d_id . '&sem_id=' . $sem_id . '&sub_id=' . $subRow['sub_id'] . '">' . sub_id($subRow['sub_id']) . '</a>';
						}							
					}
				}
				?>
					...
					while ($unitRow = mysqli_fetch_assoc($unitResult)) {
						$unitArr=unit_id($unitRow['unit_id']);
							if ($unitRow['unit_id'] == $unit_id) {
								echo '<a class="btn btn-sm btn-warning  m-2 my-2" href="view_lectures.php?d_id=' . $d_id . '&sem_id=' . $sem_id . '&sub_id='.$sub_id1.'&unit_id='.$unitRow['unit_id'].'">'.$unitArr["unit_number"].'.&nbsp;'.$unitArr["unit_name"].'</a>';
							} else {
								echo '<a class="btn btn-sm btn-primary  m-2 my-2" href="view_lectures.php?d_id=' . $d_id . '&sem_id=' . $sem_id . '&sub_id='.$sub_id1.'&unit_id='.$unitRow['unit_id'].'">'.$unitArr["unit_number"].'.&nbsp;'.$unitArr["unit_name"].'</a>';
							}					
						}
					}
				?>
	...
	//fetch the student data from databse
		...
		?>
			<tr>
				...
				?>
					<td style="text-align: center"><h6><?php echo $row['topic']; ?></h6></td>
				<?php 
				...
				?>			
					<td style="text-align: center">
						<a href="edit_lectures.php?lec_id=<?php echo $row['lec_id']; ?>" class="btn btn-primary" >Update</a>
					</td>
					<td style="text-align: center">
