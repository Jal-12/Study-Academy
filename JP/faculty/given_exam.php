                ...
                <div class="table-responsive">
                    <table class="table thover ts table-bordered ">
                        ...
                        ?>
                            ...
                            <tr>
                                <td style="text-align: center"><h6><?php echo "<b>".$No."</b>"; ?></td>
                                ...
                                <td style="text-align: center"> <a href="view_response.php?group_id=<?php echo $group_id; ?>&stu_id=<?php echo $stu_id; ?>" class="btn btn-md btn-success mb-2 mx-3">View Response</a> </td>
