                    ...
                    if (isset($subSql)) {
                        ...
                        while ($subRow = mysqli_fetch_assoc($subResult)) {
                            ...
                            if ($subRow['sub_id'] == $sub_id1) {
                                ...
                                echo '<a class="btn btn-info  m-2 my-4" href="view_groups.php?d_id=' . $d_id . '&sem_id=' . $sem_id . '&sub_id=' . $subRow['sub_id'] . '">' . sub_id($subRow['sub_id']) . '</a>';
                            }    
                        }
                    }
                    ?>
                    ...
                    <table class="table thover ts table-bordered ">
                        <thead class="table-success">
                            <tr>
                                ...
                                <th  width="8%" style="text-align: center">Group Token</th>
        ...
        ?>                    
            <tr>
                ...
                // die($start_time);
                    ...
                    echo '<td style="text-align: center">
                            <a href="add_questions.php?group_id='.$group_id.'" class="btn btn-sm btn-info " name="">Add Questions</a>
                          </td>';
                }
                ?>
