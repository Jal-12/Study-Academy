...
if (isset($_POST['upload']) && $_SERVER["REQUEST_METHOD"] == "POST" && isset($_SESSION['faculty_id']))
{
	$flag=true;
...
if (empty($_POST['semester']) || empty($_POST['sub_id']) || empty($_POST['unit_id'])) {
	...
	//file error
		...
		//insert query
					$sql = "INSERT INTO `study_materials` (`faculty_id`, `d_id`, `semester`, `sub_id`, `unit_id`, `file`) VALUES ('$faculty_id', '$department', '$semester', '$sub_id', '$unit_id', '$fileDestination')";
...
<body>
	<div class="container bg-white">
		<div class="card-header">
			<div class="row">
				<div class="col-md-12">
					<h3 class="card-title text-lg-center ">Upload Materials : <em class="text-warning"><?php echo d_id($_SESSION['d_id']); ?></em></h3>					
				</div>
