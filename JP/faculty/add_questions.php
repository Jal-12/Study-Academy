...
$group_id=$_GET['group_id'];
	...
	if (isset($_POST['add_question'])  && isset($_GET['group_id'])) {
			...
			$loop=0;
			$count=0;
			$res=mysqli_query($con,"SELECT * from exam WHERE group_id=$group_id ORDER BY group_id ASC");
			...
			if ($count==0) {
				...
				while ($row=mysqli_fetch_array($res)) {
					$loop=$loop+1;
					mysqli_query($con,"UPDATE exam SET que_no='$loop' WHERE group_id=$group_id");
				}
			}
			...
			<div class="col-md-8 offset-md-2 bg-light p-4 mt-5 rounded">
				...
				<form action="" method="POST">
					...
					<div class="form-group">
						...
						<input type="text" name="question" placeholder="Enter question" class="form-control" ><br>
					</div>
					<div class="form-group">
						<label for="question">Enter Options</label>
						<input type="text" name="option_1" placeholder="Enter Option A" class="form-control" ><br>
						<input type="text" name="option_2" placeholder="Enter Option B" class="form-control" ><br>
						<input type="text" name="option_3" placeholder="Enter Option C" class="form-control" ><br>
						<input type="text" name="option_4" placeholder="Enter Option D" class="form-control" ><br>
					...
					<center>
						<button name="add_question" type="submit" class="btn btn-info">
							Add Question
						</button>
